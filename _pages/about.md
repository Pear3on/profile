...
I am a Master’s student in Communication Theory and Systems at the University of California, San Diego (UCSD), where I am working as a Research Assistant with Prof. Dinesh Bharadia in the Wireless Communications, Sensing, and Networking Group. My research focuses on LLM-augmented reasoning over 5G/O-RAN logs, including log pruning, causal inference, and finite-state machine extraction, as well as the deployment of Edge-RIC in OAI-based 5G systems.
